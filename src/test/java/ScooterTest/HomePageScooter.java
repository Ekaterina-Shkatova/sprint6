...
public class HomePageScooter {
    ...
    public String getAnswer1() throws InterruptedException {
        Thread.sleep(1000);
        return driver.findElement(answer1).getText();
    }
    public String getAnswer2() throws InterruptedException {
        Thread.sleep(1000);
        return driver.findElement(answer2).getText();
    }
    public String getAnswer3() throws InterruptedException {
        Thread.sleep(1000);
        return driver.findElement(answer3).getText();
    }
    public String getAnswer4() throws InterruptedException {
        Thread.sleep(1000);
        return driver.findElement(answer4).getText();
    }
    public String getAnswer5() throws InterruptedException {
        Thread.sleep(1000);
        return driver.findElement(answer5).getText();
    }
    public String getAnswer6() throws InterruptedException {
        Thread.sleep(1000);
        return driver.findElement(answer6).getText();
    }
    public String getAnswer7() throws InterruptedException {
        Thread.sleep(1000);
        return driver.findElement(answer7).getText();
    }
    public String getAnswer8() throws InterruptedException {
        Thread.sleep(1000);
